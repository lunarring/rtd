...
class BaseDynamicClass(ABC):
    ...
    def process(
        ...
        Args:
            ...
            list_dynamic_coef (list of floats): Range is [0, 1]. len(list_dynamic_coef)=2. The 2 float parameters are given by the user and we want to map each of them to modulate something interesting. You access them via list_dynamic_coef[0], list_dynamic_coef[1].
