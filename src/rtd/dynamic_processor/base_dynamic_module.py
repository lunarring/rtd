...
class BaseDynamicClass(ABC):
    ...
    def process(
        ...
        Args:
            ...
            img_optical_flow (torch.Tensor): Range indicates the optical flow of the camera image. Tensor has HEIGHT x WIDTH x 2. The channels contain the x and y components of the motion vector at each pixel
